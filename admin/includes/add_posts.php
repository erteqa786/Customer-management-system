...
$post_constent=$_POST['post_content'];
$post_date=date('d-m-y');
// $post_comment_count=$_POST['po'];
...
$query.="VALUES( '{$post_category_id}' , '{$post_title}' , '{$post_author}' , now() , '{$post_status}' , '{$post_image}' , '{$post_tags}' , '{$post_constent}' )";
...
<div class="form-group">
    <label for="post_status">Post Status (published/draft)</label>
